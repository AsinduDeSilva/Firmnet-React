...
import { FaHome, FaMicrochip, FaDownload, FaTachometerAlt, FaSignOutAlt, FaCog } from 'react-icons/fa';
      ...
      <nav className="space-y-5">
        ...
        to="/settings"
            className={`flex justify-start pl-10 items-center py-[7px] mb-50 rounded-[10px] transition duration-100 ${
                currentPage === 'settings' ? 'bg-[#252c42] text-[#4b9eda]' : 'hover:bg-[#252c42] hover:text-[#4b9eda]'
            }`}
